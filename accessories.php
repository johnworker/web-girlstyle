    ...
    <section id="choose" data-aos="fade" data-aos-duration="3000">
        <div class="big_box">
            ...
            <div class="mini_max_box">
                <div class="mini_box">
                    <div class="mini_card">
                        <a href="./clothes_accessories.html" target="_blank">
                            <img src="<?php bloginfo('template_directory') ?>/img/accessories_one.jpg" alt="服裝">
                        </a>
                        <h3>時尚穿搭</h3>
                    </div>
                </div>
                ...
                <div class="mini_box">
                    <div class="mini_card">
                        <a href="./clothes_accessories.html" target="_blank">
                            <img src="<?php bloginfo('template_directory') ?>/img/accessories_two.jpg" alt="服裝">
                        </a>
                        <h3>輕鬆夏日</h3>
                    </div>
                </div>
                ...
                <div class="mini_box">
                    <div class="mini_card">
                        <a href="./clothes_accessories.html" target="_blank">
                            <img src="<?php bloginfo('template_directory') ?>/img/accessories_three.jpg" alt="服裝">
                        </a>
                        <h3>可愛風格</h3>
                    </div>
                </div>
