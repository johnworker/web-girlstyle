    ...
    <div class="items_container">
        <div class="card-1 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/img/skirt_six.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
            <h3 class="product_name">knitted skirt(white)</h3>
            <span class="product_price">$350</span>
        </div>
        <div class="card-2 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/img/girl2.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
            <h3 class="product_name">suspender skirt(black)</h3>
            <span class="product_price">$350</span>
        </div>
        <div class="card-3 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/img/skirt_eight.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
            <h3 class="product_name">silk dress(white)</h3>
            <span class="product_price">$350</span>
        </div>
        <div class="card-4 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/img/skirt_nine.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
            <h3 class="product_name">knitted skirt(pink)</h3>
            <span class="product_price">$350</span>
        </div>
        <div class="card-5 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/img/skirt_ten.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
            <h3 class="product_name">silk dress(yellow)</h3>
            <span class="product_price">$350</span>
        </div>
    </div>
    <!--  end of products  -->
