    ...
    <div class="items_container">
        <div class="card-1 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/shirt_one.jpg"
                alt="">
        ...
        <div class="card-2 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/shirt_two.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
        ...
        <div class="card-3 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/shirt_four.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
        ...
        <div class="card-4 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/shirt_three.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
        ...
        <div class="card-5 card">
            <img class="product_image"
                src="<?php bloginfo('template_directory') ?>/shirt_five.jpg"
                alt="">
            <button class="add_to_cart">Add to cart</button>
